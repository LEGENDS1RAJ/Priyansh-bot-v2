...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "🍁") || (event.body.toLowerCase() == "🤌")) {
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "😊")) {return api.sendMessage("😻 ✄─꯭─⃝͎̽⇱𝐒𝐚𝐑𝐚𝐅𝐚𝐓♡𝐒33♡♡ 𝐌𝐮𝐬𝐊𝐮𝐑𝐚𝐓⇲♡♡ 𝐑𝐚𝐇3 ⇱𝐁𝐚𝐁𝐔𝐚⇲ ⪼🩷🪇🍬🍫🪻🪽↖︎↗︎↖︎↗︎😃🤷", threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "☺️")) {return api.sendMessage("😻 ✄─꯭─⃝͎̽⇱𝐒𝐚𝐑𝐚𝐅𝐚𝐓♡𝐒33♡♡ 𝐌𝐮𝐬𝐊𝐮𝐑𝐚𝐓⇲♡♡ 𝐑𝐚𝐇3 ⇱𝐁𝐚𝐁𝐔𝐚⇲ ⪼🩷🪇🍬🍫🪻🪽↖︎↗︎↖︎↗︎😃🤷", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😇")) {return api.sendMessage("😻 ✄─꯭─⃝͎̽𝐆𝐡𝐀𝐫♡𝐖𝐚𝐋𝐎♡♡💋 𝐑𝐨𝐓𝐢 𝐍𝐚𝐡𝐢 𝐃𝐚𝐋𝐢♡♡ 𝐓𝐮𝐉𝐡𝟑 𝐀𝐣 ⇱𝐂𝐡𝐚𝐋𝐚 𝐉𝐚⇲ ⪼🩷🪇🍬🍫🪻🪽↖︎↗︎↖︎↗︎😃🤷", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🥰🥰")) {return api.sendMessage("🦋🌿Aƞƙɧ❍ Ɱɛ Ƥɣɑɽ͢  Ɗɪɭɱɛ Ƙɧuɱɑɽ🌬️🌍 ••Ƥɣɑɽ Ƭ❍ɧ Ƞɧɪ Ƙɒɽ ɭɪɣɑ Ɱuȷɧʂɛ>³••🕊️🍎😍", threadID);
    ...
    if ((event.body.toLowerCase() == "🫣")) {return api.sendMessage("😻 ✄𝐒𝐚𝐑𝐦𝐎 𝐌𝐚𝐓 𝐀𝐩𝐧𝐀 𝐡𝐢 𝐆𝐇𝐚𝐑 𝐒𝐚𝐦𝐉𝐡𝐎🌬️☞⇱𝐌𝘆 𝐌𝐢𝐒𝐒 𝐋♡♡𝐕3⇲ 😻⭐♡🧡>³••🕊️🍎😍", threadID);
     };
